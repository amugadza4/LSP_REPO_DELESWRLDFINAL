...
Assumptions: One FlightRecord exists per aircraft; records are created on first contact and removed when the aircraft leaves airspace.
...
Provide the controller with a readable summary of any queried aircraft's current flight data
